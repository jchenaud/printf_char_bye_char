...
/*   Updated: 2017/11/14 12:59:25 by jchenaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void  flag_d(va_list ap, t_env *e)
{
	...
	else if (e->have_l == 2 && e->have_h == 0 && e->have_j == 0 && e->have_z == 0)
	...
	// 	}
	// 	////////////////////////////////////////////////////////////
	// 	if(ft_atoi(e->ito) < 0 && e->ito_neg > 0)
	// 	{
	// 			ft_putchar('-');
	// 			e->nc++;
	// 			e->ito_neg = 0;
	...
	// 	modi_size = tmp;
	// }
	// else if (e->have_point != 0  && e->presition >= e->size - e->ito_neg  && ft_atoi(e->ito) != 0)
	// {
	// 	if ( e->ito_neg >= 0)
	// 	{
	// 		//mod_pres =   (e->size+1) - e->presition;
	// 		c = '0';		// ft_printf("yo\n");
	// 	}
	// 	else
	// 		mod_pres = e->presition - e->size;
	...
	// if(c == '0' && ft_atoi(e->ito) < 0 &&  e->ito_neg > 0)
	// {
	// 	ft_putchar('-');
	// 	e->ito_neg = 0;
	// 	e->nc++;
